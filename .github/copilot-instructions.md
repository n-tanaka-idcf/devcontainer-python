...
---
## 🔍 推奨レビューコメント構造（人間のレビュアー向け参考）

**注意:** GitHub Copilotの自動PRレビュー機能は独自の出力形式を持っており、
このセクションで定義されたフォーマットを強制することはできません。
以下は、人間のレビュアーやCopilot Chatでのコードレビュー時の参考として提示しています。

人間によるコードレビューやCopilot Chatを利用したレビュー時には、
可能な限り以下の構造を意識することを推奨します：
